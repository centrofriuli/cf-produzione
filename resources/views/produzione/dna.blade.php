...
<table class="table table-bordered mb-5">
    ...
    @foreach($productionDanniNoAutos as $productionDanniNoAuto)
        <tr>
            <th scope="row">{{ $productionDanniNoAuto["polizza"] }}</th>
            <td>{{ $productionDanniNoAuto["categoria"] }}</td>
            <td>{{ $productionDanniNoAuto["sotto_categoria"] }}</td>
            <td>{{ $productionDanniNoAuto["denominazione_acquisitore"] }}</td>
            <td>{{ $productionDanniNoAuto["contraente"] }}</td>
            <td>{{ $productionDanniNoAuto["data_statistica"] }}</td>
            <td>{{ $productionDanniNoAuto["premio_annualizzato"] }}</td>
        </tr>
    @endforeach
    </tbody>
</table>
